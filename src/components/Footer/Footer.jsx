...
import { FooterHeadLeng, FooterLink1, FooterLink2, FooterLink3, FooterMiniLang } from "../../configs/language";
        ...
        <div className="footer">
                ...
                <div className="footer-top">
                    ...
                    <div  className="footer-box">
                            <h3 className="footer-headers">{FooterHeadLeng[languageChange].link1}</h3>
                            <ul className="footer-list">
                                {FooterLink1.map(el => {
                                    return <li key={el.id} className="footer-item">
                                    <Link to='/' className="footer-link">{el.content[languageChange]}</Link>
                                </li>
                                })}
                            </ul>
                    </div>
                    ...
                    <div className="footer-box">
                        <h3 className="footer-headers">{FooterHeadLeng[languageChange].link2}</h3>
                    ...
                    <div className="footer-box">
                        <h3 className="footer-headers">{FooterHeadLeng[languageChange].link3}</h3>
